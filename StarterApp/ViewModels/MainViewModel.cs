...
public partial class MainViewModel : BaseViewModel
{
    ...
    {
        await _navigationService.NavigateToAsync("ReservationPage");
    }
    ...
    [RelayCommand]
    private async Task NavigateToConferencesAsync()
    { 
        if (!IsAdmin)
        {
            await Application.Current.MainPage.DisplayAlert("Access Denied", "You don't have permission to access admin features.", "OK");
        ...
        await _navigationService.NavigateToAsync("ConferencePage");
    }
